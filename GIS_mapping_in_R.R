...
# This package is great particularly if you are familiar with the `ggplot2` plotting grammar
...
# For more information on plotting maps with ggplot see [here](https://github.com/hadley/ggplot2/wiki/plotting-polygon-shapefiles) and [here](http://zevross.com/blog/2014/07/16/mapping-in-r-using-the-ggplot2-package/)
